...
@section('content')
    ...
    <form action="{{ $actionURL }}" method="POST">
        ...
        <div class='row form-group required'>
            ...
            <div class='col-md-6'>
                <select name="table" id="" class='form-control' required>
                    ...
                    <option value="mcamp" @if(isset($camp) && $camp->table == "mcamp") selected @endif>醫事人員營</option>
                    <option value="mvcamp" @if(isset($camp) && $camp->table == "mvcamp") selected @endif>醫事人員營義工</option>
                    ...
                    <option value="wcamp" @if(isset($camp) && $camp->table == "wcamp") selected @endif>講師培訓營</option>
        ...
        <div class='row form-group required'>
            ...
            <div class='col-md-6'>
                <select name="mode" id="" class='form-control' required>
                    <option value="實體" @if(isset($camp)) @selected($camp->mode == "實體" ?? true) @endif>實體</option>
                    <option value="線上" @if(isset($camp)) @selected($camp->mode == "線上" ?? false) @endif>線上</option>
                    <option value="實體＋線上" @if(isset($camp)) @selected($camp->mode == "實體＋線上" ?? false) @endif>實體＋線上</option>
                </select>
            </div>
        </div>
        <div class='row form-group'>
        ...
        <div class='row form-group'>
            <label for='inputEarlyBirdFee' class='col-md-2 control-label'>營隊早鳥費用</label>
            <div class='col-md-6'>
        ...
        <div class='row form-group'>
            <label for='inputDiscountFee' class='col-md-2 control-label'>營隊優惠費用</label>
            <div class='col-md-6'>
                <input type="number" name="discount_fee" id="" class='form-control' value="{{ $camp->discount_fee ?? "0" }}">
            </div>
        </div>

        <div class='row form-group'>
            <label for='inputDiscountLastDay' class='col-md-2 control-label'>優惠最後一日</label>
            <div class='col-md-6'>
                <input type="date" name="discount_last_day" id="" class='form-control' value="{{ $camp->discount_last_day ?? "" }}">
            </div>
        </div>
        @if($action == "建立")
