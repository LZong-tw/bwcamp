        ...
        <div class='row form-group required'>
            ...
            <div class='col-md-6'>
                <select name="mode" id="" class='form-control' required>
                    <option value="實體" @selected($camp->mode == "實體" ?? true)>實體</option>
                    <option value="線上" @selected($camp->mode == "線上" ?? false)>線上</option>
                    <option value="實體＋線上" @selected($camp->mode == "實體＋線上" ?? false)>實體＋線上</option>
                </select>
            </div>
        </div>
        <div class='row form-group'>
