...
@if(isset($applicants))
    <h3>義工名冊：</h3>
    共 {{ $applicants->count() }} 筆資料 <a href="{{ route("showAttendeePhoto", $campFullData->id) }}?download=1" target="_blank" rel="noopener noreferrer" class="btn btn-primary">將本頁下載為 PDF</a>
