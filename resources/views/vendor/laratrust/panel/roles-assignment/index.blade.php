...
{{--        </label>--}}
          ...
          <table class="min-w-full">
            <thead>
              <tr>
                ...
                <th class="th">Name</th>
                <th class="th"># 職務</th>
                @if(config('laratrust.panel.assign_permissions_to_user'))<th class="th"># 權限</th>@endif
                <th class="th"></th>
              </tr>
            </thead>
            <tbody class="bg-white">
              ...
              <tr>
                ...
                <td class="flex justify-end px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                  <a href="{{route('laratrustCustom.roles-assignment.edit', ['roles_assignment' => $user->getKey(), 'model' => $modelKey, "camp_id" => $camp_id])}}"
        ...
        @if ($modelKey)
          {{ $users->appends(['model' => $modelKey])->links('vendor.laratrust.panel.pagination') }}
        @endif
