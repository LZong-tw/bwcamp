...
<table class="table">
    ...
    <tr>
        <td>
        繳費期限：{{ substr($applicant->batch->camp->payment_deadline, 0, 4) }}/{{ substr($applicant->batch->camp->payment_deadline, 5, 2) }}/{{ substr($applicant->batch->camp->payment_deadline, 8, 2) }}<br>
