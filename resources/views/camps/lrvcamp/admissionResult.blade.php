...
@section('content')
    ...
    @if($applicant->is_admitted)
        <div class="card">
            ...
            <div class="card-body">
                <a href="https://bwcamp.bwfoce.org/downloads/lrvcamp2022/{{ $applicant->group }}{{ $applicant->number }}{{ $applicant->applicant_id }}.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-success">下載</a>
            </div>
        </div>
        <br>
    @endif
