        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    {{--
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.org/actcamp">營隊資訊</a>
                    </li>
                    --}}
                    <li class="nav-item">
                    ...
                    @endif 
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.wixsite.com/2022actcamp/schedule">課程表</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.wixsite.com/2022actcamp/報名簡章">報名簡章</a>
                    </li>
                    --}}
                </ul>
            </div>
