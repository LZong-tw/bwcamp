...
@if($applicant->batch->name == "高雄")
    <ol>
        ...
        <ol type="A">
            <li>
                <ol>
                    ...
                    <li>搭區間車至科工館站，騎Ubike沿著大順路，到建工路，右轉直騎到高科大(約10分鐘)。</li>
                </ol>
            </li>
        ...
        <li>注意事項：</li>
        <ol type="A">
            <li>校區提供免費機、汽車停車位。(向警衛先生說是參加研習的學員就
                可進入)。</li>
            <li>請自備環保杯、環保筷、雨具、健保卡。</li>
        </ol>
        <li>防疫規定：</li>
        <ol type="A">
            <li>衛生防護措施：請全程配戴口罩(用餐時間除外)、注意個人衛生防護措施，不開放發燒者進入場所或參與活動。</li>
        </ol>
        <li>營隊活動報導：</li>
        <ul style="list-style-type: none">
            <li>請見<a href="https://www.facebook.com/groups/bwfoce.happiness.new">「幸福心學堂online」FB社團</a></li>
        ...
        <li>諮詢窗口：請洽各組關懷員或 高雄場 林小姐 (07)9769341 #417</li>
    </ol>
@endif
</td></tr>
</table>
