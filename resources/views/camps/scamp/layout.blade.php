...
<head>
    ...
    <meta name='author' content='全球永續創生推廣協會'>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    {{--
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.org/scamp">營隊資訊</a>
                    </li>
                    --}}
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('query', $batch_id) }}">報名查詢/修改/取消</a>
                    </li>
                    ...
                    @endif 
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.wixsite.com/2022scamp/schedule">課程表</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://bwfoce.wixsite.com/2022scamp/報名簡章">報名簡章</a>
                    </li>
                    --}}
                </ul>
            </div>
