...
<head>
    ...
    <meta name='description' content='祈願法會' />
    <meta name='author' content='國際事務法會報名服務處'>
    <meta property='og:url' content=''/>
    <meta property='og:title' content='{{ $camp_data->abbreviation }}'/>
    <meta property='og:description' content='祈願法會' />
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="{{ url("downloads/icamp2024/天尊百现宝生百法唐卡特展報名簡章.pdf") }}">報名簡章下載(正行學員版)</a>
                    </li>
                    @else
                    <li class="nav-item">
                    <a class="nav-link" href="{{ url("downloads/icamp2024/2024祈願請法團報名簡章.pdf") }}">報名簡章及課程表下載(正行學員版)</a>
                    </li>
                    @endif
                </ul>
            </div>
...
<div class=container>
    ...
    <!-- Site footer -->
    <footer class='footer'>
        <p class=text-center>&copy; 國際事務法會報名服務處</p>
    </footer>
</div>
</body></html>
