...
@endif
    ...
    <div class='row form-group required'>
        ...
        <div class='col-md-10'>
            ...
            <div class='row form-group required'>
                ...
                <div class='col-md-10'>
                    <input type='tel' class='form-control' name="introducer_phone" value='' placeholder='格式：0225452546#520'>
                </div>
                <div class="invalid-feedback">
                    請填寫手機號碼
                </div>
    ...
    <div class='row form-group required'>
        <label for='inputName' class='col-md-2 control-label text-md-right'>被推薦人中文姓名</label>
        <div class='col-md-10'>
    ...
    <div class='row form-group'>
        <label for='inputEngName' class='col-md-2 control-label text-md-right'>被推薦人英文姓名</label>
        <div class='col-md-10'>
            <input type='text' name='english_name' value='' class='form-control' id='inputEngName' placeholder='請填寫英文全名'>
        </div>
        <div class="invalid-feedback">
            請填寫姓名
        </div>
    ...
    <div class='row form-group required'>
        <label for='inputContactTime' class='col-md-2 control-label text-md-right'>適合聯絡時間？（可複選）</label>
        <div class='col-md-10'>
    ...
    <div class='row form-group'>
    <label for='inputIntroducerRelationship' class='col-md-2 control-label text-md-right'>與推薦人關係：</label>
        <div class='col-md-10'>
    ...
    <div class='row form-group required'>
        <label class='col-md-2 control-label text-md-right text-info'>代理人(秘書/特助)</label>
        <div class='col-md-10'>
            <div class='row form-group'>
                <div class='col-md-2 text-info'>
                    代理人姓名：
            ...
            <div class='row form-group'>
                ...
                <div class='col-md-10'>
                    <input type='tel' class='form-control' name="substitute_mobile" value='' placeholder='手機格式：0225452546#520；市話格式：0225452546#520' required>
                </div>
                <div class="invalid-feedback">
                    請填寫本欄位
                </div>
    ...
    <div class='row form-group required'> 
    <label for='inputExceptionalConditions' class='col-md-2 control-label text-md-right'>被推薦人需要特別關懷事項</label>
        <div class='col-md-10'>
            <input type=text required name='exceptional_conditions' value='' class='form-control' id='inputExceptionalConditions' placeholder='例如：家庭狀況、是否有宗教信仰'>
            <div class="invalid-feedback crumb">
                請填寫特別關懷事項
            </div>
        </div>
    ...
    <hr>
    <p class='form-control-static text-danger'>請提供被推薦人之下列資訊及推薦理由：</p>
    ...
    <div class='row form-group required'> 
    <label for='inputCapital' class='col-md-2 control-label text-md-right'>資本額(新台幣：元)</label>
        <div class='col-md-10'>
    ...
    <div class='row form-group required'>
        <label for='inputOrganizationType' class='col-md-2 control-label text-md-right'>公司/組織形式</label>
        <div class='col-md-10'>
            <label class=radio-inline>
                <input type=radio required name='organization_type' value='私人公司' > 私人公司
                <div class="invalid-feedback">
                    請選擇公司/組織形式
                </div>
            </label> 
            <label class=radio-inline>
                <input type=radio required name='organization_type' value='專業領域(例醫生、作家⋯)' > 專業領域(例醫生、作家⋯)
                <div class="invalid-feedback">
                    &nbsp;
                </div>
            </label> 
            <label class=radio-inline>
                <input type=radio required name='organization_type' value='政府部門/公營事業' > 政府部門/公營事業
                <div class="invalid-feedback">
                    &nbsp;
                </div>
            </label> 
            <label class=radio-inline>
                <input type=radio required name='organization_type' value='非政府/非營利組織' > 非政府/非營利組織
                <div class="invalid-feedback">
                    &nbsp;
                </div>
            </label> 
            <label class=radio-inline>
                <input type=radio required name='organization_type' value='其它' > 其它
                <div class="invalid-feedback">
                    &nbsp;
                </div>
            </label> 
