        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    -->
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url("downloads/ceocamp2025/2025菁英營學員推薦表v2.docx") }}">學員推薦表WORD檔下載</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url("downloads/ceocamp2025/2025菁英營學員推薦表v2.pdf") }}">學員推薦表PDF檔下載</a>
                    </li>
                </ul>
            </div>
        </div>
