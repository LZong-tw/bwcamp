您好：<br>
<br>
    {{ $applicant->introducer_name }}推薦{{ $applicant->name }}報名{{ $applicant->batch->camp->fullName }}，推薦報名手續已完成，<br>
    請記下{{ $applicant->name }}的報名序號： {{ $applicant->id }} 作為日後查詢使用。<br>
    <!--錄取名單將於 {{ $applicant->batch->camp->admission_announcing_date }} 後陸續以E-mail通知。<br> -->
    <br>
    洽詢電話：<br>
    　北區：陳惠南 0989-026-085、陳美蒨 0958-367-318<br>
    　竹區：李雪貞 0933-112-571<br>
