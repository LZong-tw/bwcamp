...
<ul>
    <li>登記房型：{{ $applicant->lodging?->room_type ?? "未登記" }}</li>
    <li>住宿天數：{{ $applicant->lodging?->nights ?? "未登記" }}</li>
    <li>費用：{{ $applicant->lodging?->fare ?? 0 }}元</li>
</ul>
