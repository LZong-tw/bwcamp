<script LANGUAGE="javascript">
    ...
    //嘉義縣：民雄校區
    if (cityname == '嘉義縣')
    {   document.Camp.sname.options[ctr] = new Option ("嘉義民雄", "國立嘉義大學民雄校區") ;
        ctr = ctr + 1;
    }
    ...
    //嘉義市：蘭潭校區和新民校區
    if (cityname == '嘉義市')
    {   document.Camp.sname.options[ctr] = new Option ("嘉義蘭潭", "國立嘉義大學蘭潭校區") ;
        ctr = ctr + 1;
    }

    if (cityname == '嘉義市')
    {   document.Camp.sname.options[ctr] = new Option ("嘉義新民", "國立嘉義大學新民校區") ;
        ctr = ctr + 1;
    }
