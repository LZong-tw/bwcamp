...
<ul>
    ...
    <li>若完成繳費，請於至少一個工作天後，上網查詢是否已繳費完畢。<br>
        （<a href="{{ url('camp/' . $applicant->batch_id . '/queryadmit') }}" target="blank">{{ url('camp/' . $applicant->batch_id . '/queryadmit') }}</a>）</li>
    <li>發票於營隊第一天提供，<strong>若需開立統一編號，請於 1/22 前填寫<a href="https://docs.google.com/forms/d/e/1FAIpQLSeVcqd01trNPKMSvc-RH8Zhac5Gexn-fBaAfAWMCn323PVgFw/viewform" target="blank">申請單</a></strong>。</li>
