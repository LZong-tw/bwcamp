...
<template>
    <span>
        <div class="row form-group required">
            <label for="inputName" class="col-md-2 control-label text-md-right"
                >服務學校/單位</label
            >
            <div class="col-md-10">
                <select
                ...
                <select
                    ...
                    required
                >
                    <option :value="''" v-if="this.inputEnabled !== false">
                        - 請選擇 -
                    </option>
        ...
        return {
            ...
            schools: [
                ...
                },
                {
                    area: "屏東縣",
                    abbreviation: "慈惠醫專",
                    full_name: "慈惠醫護管理專科學校",
                    is_taichung: 0,
                },
                {
                    area: "苗栗縣",
                    abbreviation: "仁德醫專",
                    full_name: "仁德醫護管理專科學校",
                    is_taichung: 1,
                },
                {
                    area: "苗栗縣",
                ...
                },
                {
                    area: "新竹市",
                    abbreviation: "陽明交大竹",
                    full_name: "國立陽明交通大學交大校區",
                    is_taichung: 0,
                },
                {
                    area: "新竹縣",
                    abbreviation: "中國科大竹",
                    full_name: "中國科技大學新竹校區",
                    is_taichung: 0,
                },
                {
                    area: "新竹縣",
                    abbreviation: "中華科大竹",
                    full_name: "中華科技大學新竹分部",
                    is_taichung: 0,
                },
                {
                    area: "新竹縣",
