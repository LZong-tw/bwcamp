...
<template>
    <span>          
        <div class="row form-group required">
            <label for="inputName" class="col-md-2 control-label text-md-right">服務學校/單位</label>
            <div class="col-md-10">
                <select
                    class="form-control"
                    v-model="unit_area"
    ...
    data() {
        return {
            ...
            schools: [
                ...
                {area: '花蓮縣', abbreviation: '東華美崙', full_name: '國立東華大學美崙校區', is_taichung: 0}, 
                ...
                {area: '桃園市', abbreviation: '長庚科大', full_name: '長庚科技大學', is_taichung: 0}, 
                ...
                {area: '桃園市', abbreviation: '新生護專', full_name: '新生醫護管理專科學校', is_taichung: 0}, 
                {area: '桃園市', abbreviation: '萬能科大', full_name: '萬能科技大學', is_taichung: 0}, 
                {area: '桃園市', abbreviation: '銘傳桃園', full_name: '銘傳大學桃園校區', is_taichung: 0}, 
                ...
                {area: '高雄市', abbreviation: '高雄科大', full_name: '國立高雄科技大學', is_taichung: 0}, 
                ...
                {area: '高雄市', abbreviation: '實踐高雄', full_name: '實踐大學高雄校區', is_taichung: 0}, 
                ...
                {area: '新北市', abbreviation: '亞東學院', full_name: '亞東科技大學', is_taichung: 0}, 
                ...
                {area: '新北市', abbreviation: '致理科大', full_name: '致理科技大學', is_taichung: 0}, 
                {area: '新北市', abbreviation: '海洋科大', full_name: '台北海洋科技大學', is_taichung: 0}, 
                {area: '新北市', abbreviation: '真理大學', full_name: '真理大學', is_taichung: 0}, 
                {area: '新北市', abbreviation: '耕莘健管', full_name: '耕莘健康管理專科學校', is_taichung: 0}, 
                {area: '新北市', abbreviation: '馬偕醫學', full_name: '馬偕醫學院', is_taichung: 0}, 
                ...
                {area: '新竹市', abbreviation: '陽明交大竹', full_name: '國立陽明交通大學交大校區', is_taichung: 0}, 
                {area: '新竹縣', abbreviation: '中國科大竹', full_name: '中國科技大學新竹校區', is_taichung: 0}, 
                {area: '新竹縣', abbreviation: '中華科大竹', full_name: '中華科技大學新竹分部', is_taichung: 0},
                ...
                {area: '嘉義市', abbreviation: '嘉義大學', full_name: '國立嘉義大學', is_taichung: 0}, 
                {area: '嘉義縣', abbreviation: '中正大學', full_name: '國立中正大學', is_taichung: 0}, 
                {area: '嘉義縣', abbreviation: '吳鳳科大', full_name: '吳鳳科技大學', is_taichung: 0}, 
                {area: '嘉義縣', abbreviation: '長庚科大嘉', full_name: '長庚科技大學嘉義校區', is_taichung: 0}, 
                {area: '嘉義縣', abbreviation: '南華大學', full_name: '南華大學', is_taichung: 0}, 
                {area: '嘉義縣', abbreviation: '崇仁醫專', full_name: '崇仁醫護管理專科學校', is_taichung: 0}, 
                {area: '彰化市', abbreviation: '彰化師大', full_name: '國立彰化師範大學', is_taichung: 1}, 
                ...
                {area: '臺中市', abbreviation: '修平科大', full_name: '修平科技大學', is_taichung: 1}, 
                ...
                {area: '臺北市', abbreviation: '北城科大', full_name: '臺北城市科技大學', is_taichung: 0}, 
                ...
                {area: '臺北市', abbreviation: '陽明交大北', full_name: '國立陽明交通大學陽明校區', is_taichung: 0}, 
                {area: '臺北市', abbreviation: '實踐大學', full_name: '實踐大學', is_taichung: 0}, 
                ...
                {area: '臺南市', abbreviation: '南臺科大', full_name: '南臺科技大學', is_taichung: 0}, 
