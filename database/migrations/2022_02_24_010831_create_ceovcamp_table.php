...
class CreateCeovcampTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ceovcamp', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('group_priority_other', 60)->nullable();     //報名組別其它需求                
            ...
            $table->string('industry_other', 30)->nullable();           //產業別:自填
            $table->string('title', 40)->nullable();                    //職稱
            $table->string('job_property', 30)->nullable();             //工作性質
            $table->string('job_property_other', 30)->nullable();       //工作性質:自填
            ...
            $table->string('org_type_other', 30)->nullable();           //公司性質:自填
